...
#
# $Id: BBBikeAdvanced.pm,v 1.166 2006/09/21 20:08:30 eserte Exp eserte $
# Author: Slaven Rezic
#
...
sub balloon_info_from_all_tags {
	...
	if ($tags[0] =~ m{^(s|l|comm-route|comm-misc|comm-cyclepath|qs|ql|hs|hl|fz|u|b|r|f|w|rw|temp_sperre_s|L\d+)$}) {
	    my $label = $tags[1];
