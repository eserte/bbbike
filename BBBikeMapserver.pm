...
#
# $Id: BBBikeMapserver.pm,v 1.11 2003/06/29 10:18:45 eserte Exp $
# Author: Slaven Rezic
#
...
# -passparams => bool: pass existing CGI params
sub start_mapserver {
    my($self, %args) = @_;
    my $scope       = $args{'-scope'} =
    ...
    my $q2 = CGI->new({});
    if ($pass) {
	for my $param (qw(zoomsize program layer bbbikeurl bbbikemail)) {
