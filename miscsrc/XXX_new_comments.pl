...
"ab (Lichtensteinallee - Tiergartenufer) Parkweg, Fuﬂg‰nger" => Klammern weg? ja!
"nach 657 m f¸r 43 m Fuﬂg‰nger" => gruselig!
"ab Luckauer Str. Berliner Mauer-Radweg" => hier w‰re ein Doppelpunkt besser
"bis Dorotheenstr. R1" => hier auch

# Ab jetzt mit Doppelpunkten
"ab Treskowallee f¸r 2.2 km: Parkweg, OK; R1 (*); ab (Wuhlheide/FEZ): Fuﬂg‰nger " => sortieren, und zwar: Gesamtstrecken zuerst, und dann nach Startpunkt sortiert
"bis (Wuhlewanderweg, ˆstliches Ufer): bereits an der Ampel Kˆpenicker Allee die Straﬂenseite wechseln (Straﬂenbahn auf Mittelstreifen); R1 (*); ab (Wuhlewanderweg, ˆstliches Ufer): zun‰chst linken Gehweg benutzen" => f¸r PI und ‰hnliches keine Start/Endpunkte verwenden, Sortierung siehe oben
"bis Schreiberhauer Str.: sehr guter Asphalt; ab Schreiberhauer Str.: m‰ﬂiges Kopfsteinpflaster": wie bislang Q0 und q0 ignorieren
"zwischen Sonnenallee und Weigandufer" (Innstr) => was ist hier passiert? (verbessert!)
"nach 0.1 km bis Tempelhofer Ufer: reger Fuﬂg‰ngerverkehr" (Bl¸cherplatz) => besser w‰re es hier, wenn man den Gehwegbereich explizit angeben w¸rde. Oder das Kaufhaus an der Stelle
"ab Hallesches Ufer f¸r 0.0 km: reger Fuﬂg‰ngerverkehr" => hmmm, hier vielleicht die Meterangaben anzeigen oder "f¸r kurze Strecke"?
"ab Goethestr.: gutes Kopfsteinpflaster; ab Goethestr.: Mi und Sa Wochenmarkt, Behinderungen mˆglich" => kann das hier zusammengefasst werden?
