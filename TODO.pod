...
bbd.desc-Dateien zugunsten von globalen Direktiven aufgeben. Beispiele
wären:

    #: title.de: Brücken und Tunnel
    #: title.en: Bridges and tunnels

    #: category_image.bg: behindertengerecht.gif
    #: category_image.bf: behindertenfreundlich.gif
