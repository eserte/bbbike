...
String::Approx/agrep/String::Similarity-Variante für die Volltextsuche anbieten.
...
Routenprofil schöner machen, z.B. so wie hier:
http://www.klimb.org/screenshot.html

=item * (M1)

Loading plugins: show multiple errors in one dialog.
