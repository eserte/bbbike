...
pane? (it even does not fit into a 1024x768 screen on windows)

=item * (E4)

Option editor: use german labels -> FIXED? Under which circumstances
it's english?
...
Test für cgi/bbbike-data.zip schreiben
