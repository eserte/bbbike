...
Bug: drawing city streets only -> choosing "Aktive Sperrungen zeichnen und
beachten" -> drawing also region streets -> now the "Aktive Sperrungen" are
lost! They have to re-build if the checkbox is set to on and make_net is
called on something street-like
...
Tk/trans_cur.xbm and some outline directive?)
...
Die Optimierungsparameter des CGIs (textuell) in die Tk-Version
sollten verwendet werden können. Plan: Geschwindigkeitsbasierte
...
Replace all dialogs with longdialog (maybe) through a common
subroutine. Either re-use dialogs or destroy them after usage.
...
Edit mode: automatically put path into selection after drawing, so
E<quot>Path to selectionE<quot> does not need to be clicked every time
...
hinweisen, z.B. BBBike als root starten (sudo/super). Oder
su/sudo/super für die Dauer der Installation verwenden. Oder in ein
privates Verzeichnis installieren und dieses bevorzugt verwenden.
...
Pressearchiv sichten:
L<http://www.stadtentwicklung.berlin.de/aktuell/pressebox/archiv.shtml?arch=arch_0509>
(vor Januar 2001 fehlt noch)

Bezirkspressearchive (weitere in doc/watchsites.pod):

=over

=item Charlottenburg-Wilmersdorf:
L<http://www.berlin.de/ba-charlottenburg-wilmersdorf/presse/index.html>
(2006 bis 6. Juli abgearbeitet)

=item Lichtenberg:
L<http://www.berlin.de/ba-lichtenberg/presse/index.html>
(2006 bis 6. Juli abgearbeitet)

=item Mitte:
L<http://www.berlin.de/ba-mitte/index_23_hr.html>

=item Tempelhof-Schöneberg:
L<http://www.berlin.de/ba-tempelhof-schoeneberg/presse/index.html>

=item Steglitz-Zehlendorf:
L<http://www.berlin.de/ba-steglitz-zehlendorf/presse/index.html>

=item Spandau:
L<http://www.berlin.de/ba-spandau/presse/index.html>

=item Pankow:
L<http://www.berlin.de/ba-pankow/presse/index.html>

=item Marzahn-Hellersdorf:
L<http://www.berlin.de/ba-marzahn-hellersdorf/aktuelles/presse/index.html>

=item Reinickendorf: ?

=item Friedrichshain-Kreuzberg: ?

=item Treptow-Köpenick:
L<http://www.berlin.de/ba-treptow-koepenick/presse/index.html>
