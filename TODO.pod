 ...
 * option editor does not fit into 800x600 screen --- using scrollable pane? (it even does not fit into a 1024x768 screen on windows)
...
Option editor: use german labels
