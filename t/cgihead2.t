...

{
    ...
    use constant TODO_FREEBSD_PORTSMON_BROKEN => "2015-12-27T12:00:00" gt strftime("%FT%T", localtime) && 'FreeBSD portsmon/portsoverview page is broken (internal server error)';
