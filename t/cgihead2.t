...

{
    ...
    use constant TODO_CS_TU_BERLIN_UNREACHABLE => "2013-01-29T20:00:00" gt strftime("%FT%T", localtime) && 'BBBike diplom location not reachable (user.cs.tu-berlin.de down)';
}
