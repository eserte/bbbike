...
Perform a search from the start to the goal position. The parameters
in C<%args> are optional and will be passed to the underlying
C<StrassenNetz::search> method.
