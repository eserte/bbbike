...
#
# $Id: BBBikeUtil.pm,v 1.24 2007/05/13 19:27:32 eserte Exp $
# Author: Slaven Rezic
#
...
# damit ich nicht Math::Trig und Math::Complex laden muﬂ
...
# F¸hrt ein co auf die angegebene Datei $file aus.
# R¸ckgabewert: 1: OK, 0: bei "co" ist ein Fehler aufgetreten
...
sub rcs_co {
    ...
    chdir $dir or die "Kann kein chdir zum Verzeichnis $dir durchf¸hren: $!";
    system("co -l $f");
    my $ok = 1;
    if ($? != 0) {
	$ok = 0;
...
BEGIN {
    ...
    %uml_german_locale = ('‰' => 'a', 'ˆ' => 'o', '¸' => 'u', 'ﬂ' => 'ss',
			  'ƒ' => 'A', '÷' => 'O', '‹' => 'U',
			  'È' => 'e', 'Ë' => 'e', '·' => 'a',
			 );
