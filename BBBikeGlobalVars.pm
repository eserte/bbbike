...
use vars qw(
     ...
     $inwork_photo $inwork_klein_photo $sign_mini_photo $achtung_photo $cal_photo $cal_questionmark_photo $clock_photo $night_photo $xmas_photo $bomb_photo $playstreet_photo $mask_photo $star_photo $shop_photo $newlayer_photo
...
use vars qw($export_txt_mode $export_txt_min_angle $gps_waypoints
	    ...
	    $gps_needuniqueroutenumber $gps_routenamelength $gps_transfer
	   );
