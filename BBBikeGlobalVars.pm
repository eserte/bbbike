...
use vars qw(
     ...
     $inwork_photo $inwork_klein_photo $achtung_photo $cal_photo $cal_questionmark_photo $clock_photo $night_photo $xmas_photo $playstreet_photo $mask_photo $star_photo $shop_photo $newlayer_photo
