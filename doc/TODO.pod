...
-> GPS::DirectGarmin::simplify_route ist vielleicht schon allgemein
genug, um in ein anderes Modul herausgebrochen werden zu können
...
erstellen?) und Überlappungen der Route somit vermeiden.
