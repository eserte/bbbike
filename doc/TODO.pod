...
welches im parallel zur Bahnstrecke gedreht ist.
...
Introduce new types Roundabout and MiniRoundabout in comments_misc:
  ...
  - render point Roundabouts with a "kreisverkehr" sign
  - don't render lined Roundabouts at all
...
Related: it would be nice to have a function situation_at_point which
takes a route and a point and return information like:
...
normal layer order would be something like (L0=below, L1=normal
(typically missing), L2=above):

     "u/r/b-L0" "s/l-L0" "u/r/b" "s/l" "u/r/b-L1" "s/l-L1"
