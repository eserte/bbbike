...
Es gibt drei fragezeichen-Dateien am Ende:
 ...
 - fragezeichen-private-vorort-checklater (ebenso Sachen, die
...
Also: it's not possible to start install.pl from konqueror. Try the
install.pl.desktop experiment further...
