...
=> Maybe use better LVL instead of L, to avoid confusion with the
naming of custom layers (which also use an L). Also, ground level
should probably be 0, and -1 is below, and +1 is above (like in OSM
data).
