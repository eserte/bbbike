...
XXX: currently category_color.category is used instead of line_color.category

=item C<line_width: I<width>>

=item C<line_width.I<category>: I<width>>

Define the width of line items.
...
XXX: Currently C<category_dash.category.> is used instead of C<line_dash.category>.
...
XXX: The form with category form is NYI!
...
Define the size of items (for example base label font size).
