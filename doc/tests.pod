...
temporäre Sperrungen erscheinen (mit Baustellen-, Kalendar- oder
Mondsymbol).
...
keine zuverlässigen Mechanismen, um hier eine Mail zu versenden.
...
Sperrungen umfährt. Das Fenster mit den "Aktuellen Sperrungen" bleibt
