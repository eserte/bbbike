...
IF EXIST c:\programme\bbbike\windows\5.6.1\bin\MSWin32-x86\perl.exe GOTO Sieplold
IF EXIST "c:\program files\bbbike\windows\5.6.1\bin\MSWin32-x86\perl.exe" GOTO Sieperlnew
