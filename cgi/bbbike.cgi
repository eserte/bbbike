...
#XXX not yet:	    print "<td bgcolor=\"$color\">" . blind_image(1,1) . "</td>";
	...
	if ((defined $$nameref and $$nameref ne '') ||
	    ...
	    print qq{<a target="newstreetform" href="$bbbike_html/newstreetform.html?$qs">Diese Straße eintragen</a><br>\n};
	    $no_td = 1;
	    $tryempty = 1;
	} elsif ($$tworef ne '') {
		...
		if ($report_nearest) {
		    print qq{<i>$strasse</i> ist nicht bekannt (<a target="newstreetform" href="$bbbike_html/newstreetform.html?$qs">diese Straße eintragen</a>).<br>\n};
		} else {
...
//--></script>\n";
	...
	if (($start2 ne "" || $startname ne "" ||
	    ...
	    $bi->{'can_javascript'}) {
	    $button_str .= qq{<input type=button value="&lt;&lt; Zurück" onclick="history.back(1);">&nbsp;&nbsp;};
	}
...
EOF
	...
	print qq{<input type=button value="&lt;&lt; Zurück" onclick="history.back(1);">};
	print "</center>";
	print <<EOF;
<script type="text/javascript">
<!--
