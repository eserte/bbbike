...
<b>Straßen bitte ohne Hausnummern oder Postleitzahlen eingeben.</b>
EOF
	}
	print "<br><br>";
	print <<EOF if ($bi->{'can_table'});
...
##     für Rennrunde, gemütlicher Familienausflug etc. It could also be used
...
EOF
	...
	print <<EOF;
<tr>
 <td><label for="pref_fragezeichen">@{[ M("Unbekannte Straßen mit einbeziehen") ]}:</label></td>
...
#		    print ' XXXbgcolor="#ffcc66" style="background-color:#ffcc66; border-style:solid; border:white; border-width:1px;" ';
	...
	if (!$printmode) {
		...
		print qq{<a title="upload route to GPSies.com" href="$href">GPSies.com</a>};
		print "</td>";
		$maybe_do_table_br->();
	    }
