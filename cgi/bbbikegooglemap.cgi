...
EOF
    if ($use_v3) {
	$html .= <<EOF;
    <script src="https://maps.googleapis.com/maps/api/js?v=3.53&language=de"></script>
EOF
    } else {
	$html .= <<EOF;
...
EOF
	...
	if (false) {
	    return "https://" + server + ".tile.bbbike.org/osm/mapnik/" + z + "/" + a.x + "/" + a.y + ".png";
	} else {
	    return "https://" + server + ".tile.bbbike.org/osm/bbbike/" + z + "/" + a.x + "/" + a.y + ".png";
	}
    }
