...
# - qpdf:                   decompress PDF for metadata extraction
...
install_perl_dependencies() {
	...
	if debian_ubuntu_version ge ubuntu/xenial
	then
	    # note: libemail-mime-perl is always installed, as it's used in the test suite as mail parser
	    email_packages=libemail-sender-perl
	else
