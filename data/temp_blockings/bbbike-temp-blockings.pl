...
EOF
     ...
     { from  => 1251530600, # 2009-08-29 09:23
       until => 1251842399, # 2009-09-01 23:59
       text  => 'Schˆnhauser Allee (Prenzlauer Berg) in beiden Richtungen im Kreuzungsbereich Schivelbeiner Str. - Wichertstr. Baustelle, Br¸ckendurchfahrt gesperrt, aus allen Richtungen kein Linksabbiegen mˆglich (bis Anfang 09/2009)',
       type  => 'gesperrt',
       source_id => 'IM_013990',
       data  => <<EOF,
