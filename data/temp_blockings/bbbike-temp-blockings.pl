...
EOF
     ...
     { from  => 1181192400, # 2007-06-07 07:00
       ...
       text  => 'Bergmannstraﬂenfest, Bergmannstr. zwischen Mehringdamm und Zossener Str. gesperrt, 08.06.2007, 7.00 Uhr bis 10.06.2007, 24.00 Uhr ',
       type  => 'gesperrt',
...
EOF
     ...
     { from  => undef, # 
       until => undef, # last-checked 2007-11-28 # war, ist nicht mehr: Abbiegen in Kleine Auguststr. und Joachimstr. nicht mˆglich;	3 10020,13669 10081,13673 10142,13556; 	3 10142,13556 10081,13673 10214,13680
...
EOF
     ...
     { from  => 1209758305, # 2008-05-02 21:58
       ...
       text  => 'Pistoriusstr. (Weiﬂensee) Richtung Berliner Str. zwischen Gustav-Adolf-Str. und Berliner Str. Baustelle, Fahrtrichtung gesperrt (bis Ende 09.2008)',
       type  => 'gesperrt',
       source_id => 'IM_006024',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1211228484, # 2008-05-19 22:21
       ...
       text  => 'Siemensstr. (Oberschˆneweide) Richtung Edisonstr. zwischen Wilhelminenhofstr. und Edisonstr. Baustelle, Fahrbahn auf einen Fahrstreifen verengt bzw. gesperrt, eine Umleitung ist eingerichtet (bis Mitte 07.2008)',
       type  => 'handicap',
       source_id => 'IM_008562',
       data  => <<EOF,
