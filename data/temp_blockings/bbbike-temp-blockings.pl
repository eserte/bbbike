...
EOF
     ...
     { from  => 1121724000, # 2005-07-19 00:00
       ...
       text  => 'B 96; (Clara-Zetkin-Str.); OD Birkenwerder, zw. Weimarerstr. u. E.-M¸hsam-Str. grundh. Straﬂenausbau Vollsperrung 20.07.2005-01.10.2005 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1151013248, # 2006-06-22 23:54
       ...
       data  => <<EOF,
userdel	1::inwork -3972,15639 -3985,15770 -3735,16205 -3631,16224
EOF
     },
     { from  => 1150840800, # 2006-06-21 00:00
       until => 1151704800, # 2006-07-01 00:00
...
EOF
     ...
     { from  => 1152566231, # 2006-07-10 23:17
       ...
       data  => <<EOF,
userdel	q4::inwork; 18175,6376 18343,6318 18473,6265 18853,6009
EOF
     },
...
EOF
     ...
     { from  => 1156793020, # 2006-08-28 21:23
       ...
       source_id => 'IM_003370',
       data  => <<EOF,
userdel	1::inwork 18853,6009 18473,6265 18343,6318 18175,6376 17992,6436
EOF
     },
     { from  => 1160949600, # 2006-10-16 00:00
       until => 1188597600, # 2007-09-01 00:00
       text  => 'B 097 Dresdener Str. Br¸cke ober DB im OT Schwarze Pumpe Br¸ckenneubau Vollsperrung 17.10.2006-31.08.2007 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1164050202, # 2006-11-20 20:16
       ...
       text  => 'G¸rtelstr. (Friedrichshain ) in Richtung Treptow, zwischen Frankfurter Allee und Oderstr. Baustelle, Fahrtrichtung gesperrt (bis November 2007)',
       type  => 'handicap',
       source_id => 'IM_004135',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1157839200, # 2006-09-10 00:00
       until => 1199142000, # 2008-01-01 00:00
       text  => 'L 090 Dr.-K¸lz-Str. OD Glindow, zw. Alte Str. und Alpenstr. Kanal- und Straﬂenbau, starke Einschr‰nkungen 11.09.2006-31.12.2007 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1185055200, # 2007-07-22 00:00
       ...
       text  => 'B 273 Havelstr. OD Oranienburg, zw. Breite Str. und Gartenstr. Straﬂenbauarbeiten Vollsperrung 23.07.2007-25.11.2007 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       until => 1188597600, # 2007-09-01 00:00
       text  => 'Berliner Allee (Weiﬂensee) in Richtung stadteinw‰rts, in Hˆhe Rennbahnstr. Baustelle, Fahrtrichtung gesperrt (bis Sommer 2007)',
       type  => 'gesperrt',
       source_id => 'IM_005060',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1172358000, # 2007-02-25 00:00
       until => 1179525600, # 2007-05-19 00:00
       text  => 'L 040 Blankenfelde-Groﬂbeeren OD Diedersdorf, zw. Bahnhofstr. und Mahlower Str. grundhafter Straﬂenausbau Vollsperrung 26.02.2007-18.05.2007 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       until => undef, # XXX by Andreas M¸hlhausen
       text  => 'Linienstr.: Baustelle zwischen Koppenplatz (ˆstliche Straﬂe) und Rosenthaler Str., Einbahnstraﬂe, Abbiegen in Kleine Auguststr. und Joachimstr. nicht mˆglich',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1152482400, # 2006-07-10 00:00
       ...
       text  => 'L 040 Blankenfelde-Groﬂbeeren OD Diedersdorf grundhafter Straﬂenausbau Vollsperrung 11.07.2006-30.08.2007 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1179871200, # 2007-05-23 00:00
       until => 1184018400, # 2007-07-10 00:00
       text  => 'L 040 Zossener Damm OD Blankenfelde, zw. J¸hnsdorfer Weg u. A.-D¸rer-Str. Kanal- und Straﬂenbau Vollsperrung 24.05.2007-09.07.2007 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1182031200, # 2007-06-17 00:00
       until => 1191189600, # 2007-10-01 00:00
       text  => 'B 005 Treplin-Petershagen OD Petershagen, zw. KVK und Ortsausgang Kanal- und Straﬂenbau Vollsperrung 18.06.2007-30.09.2007 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       ...
       text  => 'Homburger Str.: Einbahnstraﬂe wegen Baustelle zw. Laubacher Str. und Assmannshauser Str., Durchfahrt Richtung Westen mˆglich',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1183240800, # 2007-07-01 00:00
       until => 1188597600, # 2007-09-01 00:00
       text  => 'L 339 Neuer Hˆnower Weg Bahn¸bergang in der OD Birkenstein Erneuerung Bahn¸bergang halbseitig gesperrt; Einbahnstraﬂe 02.07.2007-31.08.2007 ',
       type  => 'handicap',
       data  => <<EOF,
