...
EOF
     ...
     { from  => 1190237327, # 
       ...
       text  => 'Glinkastr. (Mitte) in beiden Richtungen zwischen J‰gerstr. und Taubenstr. Kranarbeiten, Straﬂe vollst‰ndig gesperrt',
       type  => 'gesperrt',
       source_id => 'IM_006682',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1230474668, # 2008-12-28 15:31
       ...
       text  => 'Gubitzstr. (Prenzlauer Berg) in beiden Richtungen zwischen K¸selstr. und Scheritzstr. Bauarbeiten, Straﬂe vollst‰ndig gesperrt (bis Anfang 01.2009)',
       type  => 'gesperrt',
       source_id => 'IM_010519',
       data  => <<EOF,
