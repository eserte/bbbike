...
EOF
     ...
     { from  => 1239660000, # 2009-04-14 00:00
       until => 1251756000, # 2009-09-01 00:00
       text  => 'L 022 Zehdenick - Gransee Br¸cke ¸ber den Welsegraben bei Badingen Br¸ckenbauarbeiten Vollsperrung 15.04.2009-31.08.2009 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1247954400, # 2009-07-19 00:00
       until => 1254348000, # 2009-10-01 00:00
       text  => 'L 014 Kyritz - Wittstock OD Herzsprung Straﬂenausbau Vollsperrung 20.07.2009-30.09.2009 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1243371263, # 2009-05-26 22:54
       ...
       text  => 'Glienicker Weg/Glienicker Str. (Treptow) Richtung Kˆpenick zwischen Adlergestell und Spindlersfelder Str. (DB-Br¸cke) Baustelle, Fahrtrichtung gesperrt (bis Ende 05.2013)',
       type  => 'handicap',
       source_id => 'IM_012799',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       until => undef, # XXX
       text  => 'Friedrich-Engels-Str. (Pankow) stadteinw‰rts zwischen Platanenstr. und Pastor-Niemˆller-Platz Baustelle, Fahrtrichtung gesperrt',
       type  => 'handicap',
       source_id => 'IM_013876',
       data  => <<EOF,
