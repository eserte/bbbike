...
EOF
     ...
     { from  => 1186266363, # 2007-08-05 00:26
       ...
       text  => '17. Berliner Gauklerfest, 3. bis 12. August 2007, einige Straﬂen am Opernpalais sind vollst‰ndig gesperrt ',
       type  => 'gesperrt',
       data  => <<EOF,
userdel	2::temp 9890,12161 9869,12297 9795,12293 9780,12401
userdel	2::temp 9869,12297 9852,12409
...
EOF
     ...
     { from  => 1231707258, # 2009-01-11 21:54
       ...
       text  => 'Gubitzstr. (Prenzlauer Berg) in beiden Richtungen zwischen K¸selstr. und Scheritzstr. Bauarbeiten, Straﬂe vollst‰ndig gesperrt (bis Ende 05.2009)',
       type  => 'gesperrt',
       source_id => 'IM_010519',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1241158705, # 2009-05-01 08:18
       until => 1243807199, # 2009-05-31 23:59
       text  => 'Kˆpenicker Str. (Kreuzberg) Richtung Engeldamm zwischen Heinrich-Heine-Str. und Michaelkirchstr. Baustelle, Fahrtrichtung gesperrt (bis Ende 05.2009)',
       type  => 'handicap',
       source_id => 'IM_012479',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1240517859, # 2009-04-23 22:17
       ...
       text  => 'L¸ckstr. (Lichtenberg) Richtung Nˆldnerstr. zwischen Giselastr. und Nˆldnerplatz Baustelle, Fahrtrichtung gesperrt; sowie Einbahnstraﬂenregelungen in der Giselastr. und Stadthausstr. (bis Anfang 06.09)',
       type  => 'handicap',
       source_id => 'IM_011767',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1243116000, # 2009-05-24 00:00
       ...
       text  => 'L 303 Umgehungsstraﬂe OD Eggersdorf, Krz. E.-Th‰lmann-Str. Deckenerneuerung Vollsperrung 25.05.2009-05.06.2009 ',
       type  => 'handicap',
       data  => <<EOF,
