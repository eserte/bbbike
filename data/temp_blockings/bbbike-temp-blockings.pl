...
EOF
     ...
     { from  => 1199891609, # 2008-01-09 16:13
       until => 1209592800, # 2008-05-01 00:00
       text  => 'Sterndamm (Treptow) Richtung Schˆneweide zwischen J.-Werner.Str und Lindhorstweg Baustelle, Fahrtrichtung gesperrt (bis April 2008)',
       type  => 'gesperrt',
       source_id => 'IM_007543',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1211666400, # 2008-05-25 00:00
       ...
       text  => 'L 233 Berliner Str. OD Hennickendorf Bˆschungssanierung Vollsperrung 26.05.2008-20.08.2008 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       until => undef, # XXX
       text  => 'Untere Kynaststr.: Restbauarbeiten, Straﬂe kˆnnte u.U. gesperrt sein',
       type  => 'gesperrt',
       data  => <<EOF,
