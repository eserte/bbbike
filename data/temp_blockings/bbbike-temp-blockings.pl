...
EOF
     ...
     { from  => 1150347600, # 2006-06-15 07:00
       ...
       text  => 'Bergmannstraﬂenfest, Bergmannstr. zwischen Mehringdamm und Zossener Str. gesperrt, 16.06.2006, 7.00 Uhr bis 18.06.2006, 24.00 Uhr ',
       type  => 'gesperrt',
...
EOF
     ...
     { from  => 1148113240, # 2006-05-20 10:20
       until => 1148248800, # 2006-05-22 00:00
       text  => 'Herrmannstr. (Neukˆlln) in beiden Richtungen zwischen Werbellinstr. und Thomasstr. Veranstaltung, Straﬂe vollst‰ndig gesperrt (bis 21.05.2006 24 Uhr)',
       type  => 'gesperrt',
       source_id => 'IM_002798',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1151965861, # 2006-07-04 00:31
       ...
       source_id => 'IM_003018',
       data  => <<EOF,
userdel	2::inwork 4409,3173 4582,3076 4643,3046 4825,2958
EOF
     },
...
EOF
     ...
     { from  => 1154203576, # 2006-07-29 22:06
       ...
       text  => 'Karl-Liebknecht-Str. (Mitte) in Richtung Spandauer Str., zwischen Memhardstr.. und Dircksenstr. Baustelle, Straﬂe vollst‰ndig gesperrt. Ebenfalls Einbahnstraﬂe: Teile der Dircksenstr. (bis Juni 2007) ',
       type  => 'gesperrt',
       source_id => 'IM_003157',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1168898369, # 2007-01-15 22:59
       ...
       text  => 'Weinmeisterstr. (Mitte) in beiden Richtungen, zwischen M¸nzstr. und Gipsstr. Baustelle, Straﬂe vollst‰ndig gesperrt (bis 06/2008)',
       type  => 'gesperrt',
       source_id => 'IM_004491',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1170808004, # 2007-02-07 01:26
       until => 1175378399, # 2007-03-31 23:59
       text  => 'Dunckerstr. (Prenzlauer Berg) in beiden Richtungen, Kreuzung Stargarder Str. Baustelle, Straﬂe vollst‰ndig gesperrt (bis 03.2007)',
       type  => 'gesperrt',
       source_id => 'IM_003972',
       data  => <<EOF,
userdel	2::inwork 11603,15455 11638,15522
