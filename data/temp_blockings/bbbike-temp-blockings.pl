...
EOF
     ...
     { from  => 1135045277, # 2005-12-20 03:21
       ...
       data  => <<EOF,
userdel	2 15758,10578 15880,10680 15982,10765 16038,10818 16049,10844
...
userdel auto	3 7658,11947 7460,12054 7383,12095 7039,12314
userdel auto	3 7039,12314 7383,12095 7460,12054 7658,11947
EOF
     },
     { from  => undef, # 
       until => 1148937435, # 
...
EOF
     ...
     { from  => 1150092737, # 2006-06-12 08:12
       ...
       source_id => 'IM_002885',
       data  => <<EOF,
userdel	q4; 15639,10469 15758,10578 15880,10680 15982,10765 16038,10818 16049,10844
EOF
     },
     { from  => undef, # 
       until => 1139470769, #
...
EOF
     ...
     { from  => 1145649600, # 2006-04-21 22:00
       ...
       type  => 'gesperrt',
       data  => <<EOF,
userdel	2 21179,4249
userdel	2 21053,4162 21146,4229 21179,4249
EOF
     },
...
EOF
     ...
     { from  => 1339711200, # 1150395890, # 2006-06-15 20:24
       ...
       text  => 'Altstadt Köpenick: 51. Köpenicker Sommer vom 15. bis 17. Juni 2012',
       type  => 'handicap',
...
EOF
     ...
     { from  => 1151099435, # 2006-06-23 23:50
       ...
       data  => <<EOF,
userdel	2 20692,3951 20772,3999 20788,4008 20834,4035 21053,4162 21146,4229 21179,4249 21193,4305 21206,4387 21289,4563 21332,4655
EOF
     },
...
EOF
     ...
     { from  => 1161326798, # 2006-10-20 08:46
       ...
       source_id => 'IM_003850',
       data  => <<EOF,
userdel	q4::temp 8481,16136 8582,16052 8443,15901 8437,15894 8271,15734
...
EOF
     ...
     { from  => undef, # 
       ...
       source_id => 'IM_005060',
       data  => <<EOF,
userdel	1::inwork 14535,17003 14558,16907
EOF
     },
...
EOF
     ...
     { from  => 1181768521, # 
       ...
       source_id => 'IM_005746',
       data  => <<EOF,
userdel	q4::inwork; 20832,3170 20779,3046 20704,2939 20651,2869 20565,2754
EOF
     },
...
EOF
     ...
     { from  => undef, # 
       ...
       source_id => 'IM_006236',
       data  => <<EOF,
userdel	1::inwork 16049,10844 15983,10836 15681,10801 15433,10765 15388,10758 15272,10790
EOF
     },
...
EOF
     ...
     { from  => 1190237300, # 2007-09-19 23:28
       ...
       source_id => 'IM_006691',
       data  => <<EOF,
userdel	1::inwork 16468,10695 16313,10747 16300,10753 16153,10818 16085,10844 16049,10844
EOF
     },
...
EOF
     ...
     { from  => 1194897448, # 2007-11-12 20:57
       ...
       source_id => 'IM_007093',
       data  => <<EOF,
userdel	1::inwork 16313,10747 16300,10753 16153,10818 16085,10844 16049,10844
EOF
     },
     { from  => 1195308223, # 
       until => 1195308227, #
...
EOF
     ...
     { from  => 1247724607, # 2009-07-16 08:10
       ...
       source_id => 'IM_009763',
       data  => <<EOF,
userdel	q4::inwork 22740,4415 22759,4430 22791,4457 22832,4491 22862,4511 22893,4532 22959,4576 23059,4635 23363,4846 23451,4877
EOF
     },
...
EOF
     ...
     { from  => 1243371742, # 2009-05-26 23:02
       ...
       source_id => 'IM_011757',
       data  => <<EOF,
userdel	1::inwork 15982,10765 16038,10818 16049,10844
EOF
     },
...
EOF
     ...
     { from  => 1249414524, # undef
       ...
       source_id => 'IM_013849',
       data  => <<EOF,
userdel	q4::inwork 15639,10469 15758,10578 15880,10680 15982,10765 16038,10818 16049,10844
EOF
     },
...
EOF
     ...
     { from  => 1251712860, # 2009-08-31 12:01
       ...
       source_id => 'IM_014045',
       data  => <<EOF,
userdel	q4::inwork; 23451,4877 23363,4846 23059,4635 22959,4576 22893,4532 22862,4511 22832,4491 22791,4457 22759,4430 22740,4415
EOF
     },
     { from  => 1250978400, # 2009-08-23 00:00
       until => 1262300399, # 2009-12-31 23:59
...
EOF
     ...
     { from  => 1371938400, # 2013-06-23 00:00
       until => 1374832800, # 2013-07-26 12:00
...
EOF
     ...
     { from  => 1378015200, # 2013-09-01 08:00
       until => 1379253600, # 2013-09-15 16:00
