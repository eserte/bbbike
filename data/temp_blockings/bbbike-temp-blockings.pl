...
#: XXX nach Beendigung der Bauarbeiten ist wahrscheinlich die gesamte Straﬂe asphaltiert, mit einigen Aufpflasterungen
...
EOF
     ...
     { from  => 1251756000, # 2009-09-01 00:00
       ...
       text  => 'Fuﬂg‰ngertunnel Lange Br¸cke: unter Umst‰nden vollst‰ndig gesperrt (September 2009 - Dezember 2009)',
       type  => 'gesperrt',
...
EOF
     ...
     { from  => undef, # 
       until => undef, # XXX
       text  => 'Proskauer Str. (Friedrichshain) in beiden Richtungen zwischen Rigaer Str. und B‰nschstr. geplatzte Wasserleitung, Straﬂe vollst‰ndig gesperrt (auf weiteres)',
       type  => 'handicap',
       source_id => 'IM_013998',
       data  => <<EOF,
