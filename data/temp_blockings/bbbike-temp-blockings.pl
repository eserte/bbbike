...
userdel auto	3 9837,9856 9827,10051 10006,9942
userdel auto	3 9837,9856 9827,10051 9689,10124
userdel auto	3 9689,10124 9827,10051 10006,9942
...
EOF
     ...
     { from  => 1148565600, # 2006-05-25 16:00
       ...
       type  => 'gesperrt',
       data  => <<EOF,
userdel	2 8515,12242 8214,12205 8089,12190
...
EOF
     ...
     { from  => 1158865257, # 2006-09-21 21:00
       ...
       source_id => 'IM_003565',
       data  => <<EOF,
userdel	q4::temp 8515,12242 8214,12205 8089,12190
...
EOF
     ...
     { from  => 1159426800, # 2006-09-28 09:00
       ...
       type  => 'gesperrt',
       data  => <<EOF,
userdel	2::temp 8055,12186 8089,12190 8214,12205 8515,12242 8539,12286 8560,12326 8540,12420
...
EOF
     ...
     { from  => 1166648042, # 2006-12-20 21:54
       ...
       source_id => 'IM_004369',
       data  => <<EOF,
userdel	q4::temp 8089,12190 8214,12205 8515,12242
EOF
     },
     { from  => undef, # 
...
EOF
     ...
     { from  => 1168462111, # 2007-01-10 21:48
       ...
       source_id => 'IM_004454',
       data  => <<EOF,
userdel	2::temp 9106,12795 8870,12647
EOF
     },
...
EOF
     ...
     { from  => 1174515627, # 2007-03-21 23:20
       ...
       source_id => 'IM_005018',
       data  => <<EOF,
userdel	2::temp 8540,12420 8560,12326 8539,12286 8515,12242 8214,12205 8089,12190 8055,12186
userdel	2::temp 8595,12066 8600,12165 8515,12242
EOF
     },
...
EOF
     ...
     { from  => 1177103052, # 2007-04-20 23:04
       ...
       source_id => 'IM_005268',
       data  => <<EOF,
userdel	2::temp 6828,12031 7383,12095 7816,12150 8055,12186 8089,12190 8214,12205 8515,12242
EOF
     },
...
EOF
     ...
     { from  => 1179900343, # 2007-05-23 08:05
       ...
       source_id => 'IM_005565',
       data  => <<EOF,
userdel	2::temp 8089,12190 8214,12205 8515,12242
EOF
     },
...
EOF
     ...
     { from  => 1182577874, # 2007-06-23 07:51
       until => 1182722400, # 2007-06-25 00:00
       text  => 'Badstraﬂe (Wedding) in beiden Richtungen zwischen Pankstraﬂe und Behmstraﬂe Veranstaltung, Straﬂe gesperrt (bis 24.06.2007 nachts)',
       type  => 'gesperrt',
       source_id => 'IM_005849',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1183704492, # 2007-07-06 08:48
       ...
       source_id => 'IM_006009',
       data  => <<EOF,
userdel	2::temp 8515,12242 8214,12205 8089,12190
EOF
     },
...
EOF
     ...
     { from  => 1188240671, # 
       ...
       source_id => 'IM_006364',
       data  => <<EOF,
userdel	2::temp 8610,12254 8515,12242 8214,12205 8089,12190 8055,12186
EOF
     },
...
EOF
     ...
     { from  => 1195308071, # 2007-11-17 15:01
       ...
       text  => 'Baumschulenstr. (Treptow) in beiden Richtungen Hˆhe S-Bahnbr¸cke Baustelle, Straﬂe vollst‰ndig gesperrt ist ausgeschildert (bis 19.11. 05 Uhr)',
       type  => 'gesperrt',
       source_id => 'IM_007201',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1198881536, # 2007-12-28 23:38
       ...
       source_id => 'IM_007479',
       data  => <<EOF,
userdel	2::inwork 8600,12165 8515,12242 8214,12205 8089,12190
...
EOF
     ...
     { from  => 1214257459, # 2008-06-23 23:44
       ...
       source_id => 'IM_009181',
       data  => <<EOF,
userdel	q4::temp 6828,12031 7383,12095 7816,12150 8055,12186 8089,12190 8214,12205 8515,12242 8539,12286 8560,12326 8540,12420
...
userdel auto	3 7118,11209 6880,11110 6841,11114
userdel auto	3 6841,11114 6880,11110 7118,11209
...
EOF
     ...
     { from  => 1215067855, # 2008-07-03 08:50
       ...
       type  => 'gesperrt',
       data  => <<EOF,
userdel	2::temp 8539,12286 8515,12242 8214,12205 8089,12190
...
userdel	2::temp 8775,12457 8540,12420 8560,12326 8539,12286 8515,12242 8214,12205 8089,12190 8055,12186 7816,12150 7383,12095 6828,12031
userdel	2::temp 8595,12066 8600,12165 8515,12242
EOF
     },
...
userdel	2::temp 6642,12010 6685,11954 6744,11936 6809,11979 6828,12031 7383,12095 7816,12150 8055,12186 8089,12190 8214,12205 8515,12242
...
EOF
     ...
     { from  => 1238347043, # 2009-03-29 19:17
       ...
       text  => 'Wendenschloﬂstr. (Kˆpenick) in beiden Richtungen zwischen Landj‰gerstr. und M¸ggelheimer Str. Baustelle, Straﬂe vollst‰ndig gesperrt (bis Ende 2010)',
       type  => 'handicap',
       source_id => 'IM_009763',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1230474969, # 2008-12-28 15:36
       ...
       source_id => 'IM_010978',
       data  => <<EOF,
userdel	2::temp 8119,12414 8055,12186 8089,12190 8214,12205 8515,12242 8539,12286
userdel	2::temp 8595,12066 8600,12165 8515,12242
userdel	2::temp 8055,12186 7816,12150 7383,12095 6828,12031
...
EOF
     ...
     { from  => 1237071600, # 2009-03-15 00:00
       ...
       text  => 'B 198 Polﬂen - Gramzow OD Meichow grundhafter Straﬂenbau Vollsperrung 16.03.2009-24.06.2009 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1238450400, # 2009-03-31 00:00
       ...
       text  => 'B 002 Wittenberg - LG - Treuenbrietzen OD Marzahna Kanal- und Straﬂenbau halbseitig gesperrt; Einbahnstraﬂe 01.04.2009-30.09.2009 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1243807200, # 2009-06-01 00:00
       ...
       text  => 'B 102 Wildberg - Neustadt-Dosse Kreuzungsber. B 5 bei B¸ckwitz Kreiselneubau Vollsperrung 02.06.2009-22.07.2009 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1247954400, # 2009-07-19 00:00
       ...
       text  => 'L 014 Kyritz - Wittstock OD Herzsprung grundhafter Straﬂenausbau Vollsperrung 20.07.2009-18.09.2009 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1243116000, # 2009-05-24 00:00
       ...
       text  => 'L 014 Kyritz - Wittstock OD Herzsprung grundhafter Straﬂenausbau Vollsperrung 25.05.2009-20.07.2009 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1243371714, # 2009-05-26 23:01
       ...
       text  => 'Glinkastr. (Mitte) Richtung Leipziger Str. zwischen Franzˆsische Str. und J‰gerstr. Baustelle, Fahrtrichtung gesperrt (bis Ende 09.2009)',
       type  => 'handicap',
       source_id => 'IM_012764',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1244584654, # 2009-06-09 23:57
       ...
       text  => 'John-Foster-Dulles-Allee (Tiergarten) in beiden Richtungen zwischen Groﬂe Querallee und Yitzhak-Rabin-Str. Veranstaltung, Straﬂe vollst‰ndig gesperrt (bis 13.06.2009, ca. 6 Uhr)',
       type  => 'gesperrt',
       source_id => 'IM_012990',
       data  => <<EOF,
