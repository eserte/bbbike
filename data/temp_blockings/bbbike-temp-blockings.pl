...
userdel	2 -12553,-1025 -12552,-1097 -12552,-1233 -12549,-1277
...
EOF
     ...
     { from  => 1146088800, # 2006-04-27 00:00
       ...
       type  => 'gesperrt',
       data  => <<EOF,
userdel	1 9248,9350 9235,9111 9235,9051 9234,9038 9227,8890 9229,8785
EOF
     },
...
userdel	q4 9395,8726 9272,8781 9229,8785 9229,8718 9233,8597 9232,8410 9233,8254 9229,8029 9227,7797 9231,7657 9236,7324 9234,7287 9234,7220 9235,7146
userdel auto	3 9227,8890 9229,8785 9050,8783
userdel auto	3 9050,8783 9229,8785 9227,8890
EOF
     },
...
EOF
     ...
     { from  => 1173682113, # 2007-03-12 07:48
       ...
       source_id => 'IM_004915',
       data  => <<EOF,
userdel	2::inwork 8306,8722 8237,8685 8219,8628 7950,7840
EOF
     },
     { from  => 1173913200, # 2007-03-15 00:00
       until => 1174345200, # 2007-03-20 00:00
...
EOF
     ...
     { from  => 1174068849, # 2007-03-16 19:14
       ...
       text  => 'Reichstagufer (Mitte) in beiden Richtungen Baustelle, Straﬂe vollst‰ndig gesperrt, Fuﬂg‰nger kˆnnen passieren (bis 30.09.2008)',
       type  => 'handicap',
       source_id => 'IM_004994',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       until => 1214463306, # undef last-checked 2007-11-28 # war, ist nicht mehr: Abbiegen in Kleine Auguststr. und Joachimstr. nicht mˆglich;	3 10020,13669 10081,13673 10142,13556; 	3 10142,13556 10081,13673 10220,13691
...
EOF
     ...
     { from  => 1181165074, # undef
       until => 1181165075, # XXX undef (nur noch "Verkehrsstˆrung erwartet)
...
EOF
     ...
     { from  => Time::Local::timelocal(reverse(2008-1900,6-1,29,0,0,0)), #
       ...
       source_id => 'IM_005931',
       data  => <<EOF,
userdel	1::temp 9248,9350 9235,9111 9235,9051 9234,9038 9227,8890 9229,8785
EOF
     },
...
EOF
     ...
     { from  => 1231707233, # 2009-01-11 21:53
       ...
       text  => 'Glinkastr. (Mitte) in beiden Richtungen zwischen J‰gerstr. und Taubenstr. Baustelle, Straﬂe vollst‰ndig gesperrt (bis Ende 05.2009)',
       type  => 'gesperrt',
       source_id => 'IM_009496',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1199574000, # 2008-01-06 00:00
       ...
       text  => 'Bauarbeiten am nordwestlichen Bereich der Elsenbr¸cke von 7. Januar 2008 bis Oktober 2008; kein Zugang zum Spreeufer. ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1210313171, # 2008-05-09 08:06
       ...
       text  => 'Straﬂen um den Bl¸cherplatz Kreuzberg Bl¸cherplatz, Waterlooufer: Mehringdamm - Zossener Str., Bl¸cherstr.: Mehringdamm - Zossener Str., Zossener Str.: Waterlooufer-Bl¸cherstr. gesperrt (bis 12.05.08, 24:00 Uhr)',
       type  => 'gesperrt',
       source_id => 'IM_008714',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1229382000, # 2008-12-16 00:00
       ...
       text  => 'B 246 Ernst-Th‰lmann-Straﬂe OL Storkow, zw. Burgstraﬂe u. Am Bahnhof Deckenerneuerung Vollsperrung * 17.12.2008-30.03.2009 ',
       type  => 'handicap',
       data  => <<EOF,
...
userdel	2::temp 8553,11630 8548,11552 8542,11502 8505,11494 8374,11477
userdel	2::temp 9984,12426 9915,12417 9852,12409 9780,12401 9752,12398 9679,12388 9601,12380 9475,12365 9393,12357 9358,12351 9141,12320 9164,12172 9064,12156
...
EOF
     ...
     { from  => 1219879749, #  undef
       ...
       source_id => 'IM_009757',
       data  => <<EOF,
userdel	2::temp 9396,13176 9245,13162
EOF
     },
...
EOF
     ...
     { from  => 1219879715, # 2008-08-28 01:28
       ...
       text  => 'Wendenschloﬂstr. (Kˆpenick) stadteinw‰rts zwischen Salvador-Allende-Str. und M¸ggelheimer Str. Baustelle, Fahrtrichtung gesperrt (bis Ende 2010)',
       type  => 'gesperrt',
       source_id => 'IM_009763',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1228340492, # 2008-12-03 22:41
       until => 1233442799, # 2009-01-31 23:59
       text  => 'Nˆldnerstr. (Lichtenberg) Richtung Karlshorster Str. zwischen L¸ckstr. und Karlshorster Str. Baustelle, Fahrtrichtung gesperrt (bis Ende 01.2009)',
       type  => 'gesperrt',
       source_id => 'IM_010255',
       data  => <<EOF,
userdel	1::inwork 16032,10842 15670,10800 15388,10758 15272,10790
