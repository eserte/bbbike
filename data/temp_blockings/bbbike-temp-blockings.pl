...
EOF
     ...
     { from  => 1191967812, # 2007-10-10 00:10
       ...
       text  => 'Glinkastr. (Mitte) Richtung Leipziger Str. zwischen Franzˆsische Str. und Leipziger Str. Baustelle, Fahrtrichtung gesperrt (bis Ende 2008)',
       type  => 'gesperrt',
       source_id => 'IM_006819',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1211666400, # 2008-05-25 00:00
       ...
       text  => 'B 246 Ernst-Th‰lmann-Straﬂe OL Storkow, zw. Burgstraﬂe u. Am Bahnhof Deckenerneuerung Vollsperrung 26.05.2008-31.12.2008 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1216159200, # 2008-07-16 00:00
       until => 1230764400, # 2009-01-01 00:00
       text  => 'L 141 Breddin - K¸mmernitz OD Breddin Straﬂenneubau Vollsperrung 17.07.2008-31.12.2008 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1227351275, # 2008-11-22 11:54
       ...
       text  => 'Ordensmeisterstr. (Tempelhof) in beiden Richtungen zwischen Wenckebachstr. und Tempelhofer Damm Baustelle, Straﬂe vollst‰ndig gesperrt (bis Anfang 03.2009)',
       type  => 'gesperrt',
       source_id => 'IM_010086',
       data  => <<EOF,
userdel	2::inwork 9357,5601 9147,5534
...
EOF
     ...
     { from  => 1226267528, # 2008-11-09 22:52
       until => 1228085999, # 2008-11-30 23:59
       text  => 'Gubitzstr. (Prenzlauer Berg) in beiden Richtungen zwischen K¸selstr. und Scheritzstr. Bauarbeiten, Straﬂe vollst‰ndig gesperrt (bis Ende 11.2008)',
       type  => 'gesperrt',
       source_id => 'IM_010519',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1226267554, # 2008-11-09 22:52
       ...
       text  => 'Kˆthener Str. (Kreuzberg) Richtung Hallesches Ufer zwischen Stresemannstr. und Hallesches Ufer Baustelle, Fahrtrichtung gesperrt ausgeschildert (bis Anfang 6.2010)',
       type  => 'gesperrt',
       source_id => 'IM_010401',
       data  => <<EOF,
