...
EOF
     ...
     { from  => 1162249200, # 2006-10-31 00:00
       ...
       text  => 'L 073 Beelitzer Str. OD Luckenwalde, zw. B101 und Puschkinstr. Straﬂenausbau Vollsperrung 01.11.2006-28.02.2007 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1170098789, # 2007-01-29 20:26
       until => 1175378399, # 2007-03-31 23:59
       text  => 'Nennhauser Damm (Spandau) Richtung Brunsb¸tteler Damm nach Heerstr. Baustelle, Fahrtrichtung gesperrt (bis Ende 03.2007)',
       type  => 'gesperrt',
       source_id => 'IM_004443',
       data  => <<EOF,
