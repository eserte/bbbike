...
EOF
     ...
     { from  => 1244930400, # 2009-06-14 00:00
       ...
       text  => 'K 6422 Eggersdorfer Str. OL Petershagen, zw. Gravenhainstr. u. Johannesstr. Straﬂenausbau Vollsperrung 15.06.2009-30.04.2010 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1252447200, # 2009-09-09 00:00
       ...
       text  => 'L 373 B112 - M¸llrose OL Brieskow-Finkenheerd, Gubener Str. - R.-Sonnenburg-Str. Deckenerneuerung Vollsperrung 10.09.2009-12.09.2009 ',
       type  => 'handicap',
       data  => <<EOF,
