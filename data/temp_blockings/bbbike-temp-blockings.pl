...
EOF
     ...
     { from  => 1194130800, # 2007-11-04 00:00
       until => 1220220000, # 2008-09-01 00:00
       text  => 'B 167 OD Alt Ruppin, zw. Br¸ckenstr. und Neum¸hler Weg Straﬂen- u. Br¸ckenbauarbeiten Vollsperrung 05.11.2007-31.08.2008 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1190498400, # 2007-09-23 00:00
       ...
       text  => 'L 073 Beelitzer Str. OL Luckenwalde, zw. Puschkinstr. u. Woltersdorfer Str. Straﬂenausbau Vollsperrung 24.09.2007-31.10.2008 ',
       type  => 'handicap',
       data  => <<EOF,
userdel	q4::inwork -4725,-34957 -5019,-34814
EOF
...
EOF
     ...
     { from  => 1203202800, # 2008-02-17 00:00
       until => 1230764400, # 2009-01-01 00:00
       text  => 'B 001 Brandenburger Str. OD Jeserig Straﬂenbau Vollsperrung 18.02.2008-31.12.2008 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1208892535, # 2008-04-22 21:28
       until => 1222811999, # 2008-09-30 23:59
       text  => 'Schillerstr. (Wilhelmsruh) Richtung Schˆnholzer Weg zwischen Hauptstr. und Schˆnholzer Weg Baustelle, Fahrtrichtung gesperrt (bis 09.2008)',
       type  => 'gesperrt',
       source_id => 'IM_008423',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1214517600, # 2008-06-27 00:00 # XXX DO NOT REUSE DATA!
       ...
       type  => 'gesperrt',
       data  => <<EOF,
userdel	2::temp 8358,11475 8301,11469 8226,11458 8083,11381 8065,11349 8025,11239 7993,11137 7980,11070 7968,11048 7912,10945 7820,10768 7689,10514 7633,10394 7579,10183 7413,10244 7245,10297 7131,10331 7033,10328 6971,10346 6937,10363 6851,10416 6753,10446 6636,10485 6536,10520 6674,10693 6732,10754 6824,10904 6873,11011 6882,11061 6880,11110 6853,11336 6825,11486 6809,11570 6778,11742 6744,11936
...
userdel auto	3 7873,11142 7993,11137 8092,11092
...
userdel auto	3 7470,10579 7689,10514 7849,10488
...
userdel auto	3 7849,10488 7689,10514 7470,10579
userdel auto	3 7160,11225 6853,11336 6683,11367
userdel auto	3 8092,11092 7993,11137 7873,11142
...
EOF
     ...
     { from  => 1215030238, # 2008-07-02 22:23
       until => 1217541599, # 2008-07-31 23:59
       text  => 'An der Spandauer Br¸cke (Mitte) Richtung Spandauer Str. zwischen Rosenthaler Str. und Spandauer Str. Baustelle, Fahrtrichtung gesperrt, eine Umleitung ist eingerichtet (bis Ende 07.2008)',
       type  => 'gesperrt',
       source_id => 'IM_009262',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1216159200, # 2008-07-16 00:00
       until => 1220133600, # 2008-08-31 00:00
       text  => 'L 141 Breddin - K¸mmernitz OD Breddin Straﬂenneubau Vollsperrung 17.07.2008-30.08.2008 ',
       type  => 'handicap',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1216159200, # 2008-07-16 00:00
       ...
       text  => 'L 029 Lanke - Zehlendorf nˆrdl. Wandlitz, zw. B109 und Bahn¸bergang Bau Kreisverkehr Vollsperrung 17.07.2008-17.08.2008 ',
       type  => 'gesperrt',
       data  => <<EOF,
...
EOF
     ...
     { from  => undef, # 
       until => undef, # XXX
       text  => 'Friedrich-Karl-Str., Ordensmeisterstr. (Tempelhof) in beiden Richtungen zwischen Ottokarstr. und Wenckebachstr. Baustelle, Straﬂe vollst‰ndig gesperrt',
       type  => 'gesperrt',
       source_id => 'IM_009406',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1216674398, # 2008-07-21 23:06
       ...
       text  => 'Greifswalder Str. (Prenzlauer Berg) stadteinw‰rts zwischen Ostseestr. und Erich-Weinert-Str. Baustelle, Fahrtrichtung gesperrt (bis ca. 28.07.2008)',
       type  => 'gesperrt',
       source_id => 'IM_009449',
       data  => <<EOF,
...
EOF
     ...
     { from  => 1216756080, # 2008-07-22 21:48
       ...
       text  => 'Straﬂe des 17. Juni (Tiergarten) in Richtung Charlottenburg zwischen Y.-Rabin-Str. und Groﬂer Stern Veranstaltung, Fahrtrichtung gesperrt (bis 25.08.2008 6 Uhr)',
       type  => 'gesperrt',
       source_id => 'IM_009465',
       data  => <<EOF,
