...
',
         'from' => undef,
         'id' => 4608,
         'text' => 'Auguste-Viktoria-Allee/General-Barby-Str./Engelmannweg: Bauarbeiten, Sperrungen von Fahrbahnen und Einbahnstraßenregelungen, teilweise größere Umwege notwendig, Ende der Bauarbeiten unbekannt',
         'type' => 'handicap',
         'until' => undef
       },
       {
