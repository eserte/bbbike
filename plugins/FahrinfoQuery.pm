...
# Author: Slaven Rezic
#
# Copyright (C) 2010,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025,2026 Slaven Rezic. All rights reserved.
...
######################################################################
# configurable
my $openvbb_download_size = '73MB';
my $openvbb_year = 2026;
my $openvbb_index = 2;
