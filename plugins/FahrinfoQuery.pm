...
my $openvbb_2013_download_size = '27MB';
my $openvbb_2013_data_url = 'http://www.vbb.de/de/datei/GTFS_VBB_Apr2014-Aug2014.zip';
my $openvbb_2013_archive_file = "$bbbike_root/tmp/" . basename($openvbb_2013_data_url);
my $openvbb_2013_local_file = "$bbbike_root/tmp/" . basename($openvbb_2013_data_url, '.zip') . '_stops.txt';
my $openvbb_2013_bbd_file = "$bbbike_root/tmp/vbb_2014_2.bbd";
